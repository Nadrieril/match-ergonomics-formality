...
impl Conf {
  ...
  pub fn rust_2021() -> Self {
    Self::default()
  }

  pub fn rust_2021_proposed() -> Self {
    Self {
      rule3: true,
      rule4: true,
      rule4_ext: true,
  ...
  pub fn rust_2024() -> Self {
    Self { rule1: true, rule2: true, ..<_>::default() }
  }

  pub fn rust_2024_proposed() -> Self {
    Self {
      rule1: true,
      rule2: true,
      rule3: true,
  ...
  pub fn rust_2024_rpjohnst() -> Self {
    Self {
      rule1: true,
      rule2: true,
      rule3_lazy: true,
  ...
  pub fn set(&mut self, flag: &str) -> Result<(), ConfError> {
    match flag {
      "stable" => *self = Self::rust_2021(),
      "proposed" | "rfc" => *self = Self::rust_2024_proposed(),
      "rpjohnst" => *self = Self::rust_2024_rpjohnst(),
      "waffle" => *self = Self::rust_2024_waffle(),
      _ => {
...
pub fn node_step(
  ...
  if ns.behind_ref {
    match (next_node.node, edge_ty) {
      ...
      (Move, BindingVsRefMut) => ns.err(RefMutNotAllowedBehindRef),
